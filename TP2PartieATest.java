...
public class TP2PartieATest
{
    ...
    @Test
    public void WHEN_evenNumberOfCellsInArray_THEN_swapArray(){
        //Arrange        
    ...
    @Test
    public void WHEN_binaryNumberRepresentsInt_44_THEN_convertFromBinaryToInt_returnsIntValue(){
        //Arrange        
        final char[] BINARY_ARRAY = {'1','0','1','1','0','0'};

        //Act
        int intValue = TP2PartieA.convertFromBinaryToInt(BINARY_ARRAY);

        //Assert
        final int EXPECTED_INT_VALUE = 44;
        assertEquals(EXPECTED_INT_VALUE, intValue);
    }
    
    @Test
    public void WHEN_binaryNumberRepresentsInt_41_THEN_convertFromBinaryToInt_returnsIntValue(){
        //Arrange        
        final char[] BINARY_ARRAY = {'1','0','1','0','0','1'};

        //Act
        int intValue = TP2PartieA.convertFromBinaryToInt(BINARY_ARRAY);

        //Assert
        final int EXPECTED_INT_VALUE = 41;
        assertEquals(EXPECTED_INT_VALUE, intValue);
    }
    
    @Test
    public void WHEN_intValueIs_89_THEN_convertFromIntToBinary_returnsBinaryRepresentationOfIntValue(){
        //Arrange
        int INT_VALUE = 89;
        int BINARY_ARRAY_SIZE = 7;

        //Act
        char[] binaryArray = TP2PartieA.convertFromIntToBinary(INT_VALUE, BINARY_ARRAY_SIZE);

        //Assert
        final char[] EXPECTED_BINARY_ARRAY = {'1','0','1','1','0','0','1'};
        assertArrayEquals(EXPECTED_BINARY_ARRAY, binaryArray);
    }
    
    @Test
    public void WHEN_intValueIs_45_THEN_convertFromIntToBinary_returnsBinaryRepresentationOfIntValue(){
        //Arrange
        int INT_VALUE = 45;
        int BINARY_ARRAY_SIZE = 6;

        //Act
        char[] binaryArray = TP2PartieA.convertFromIntToBinary(INT_VALUE, BINARY_ARRAY_SIZE);

        //Assert
        final char[] EXPECTED_BINARY_ARRAY = {'1','0','1','1','0','1'};
        assertArrayEquals(EXPECTED_BINARY_ARRAY, binaryArray);
    }
    
    @Test
    public void WHEN_charIs_f_THEN_convertCharToBinary_returnsBinaryRepresentationOfChar(){
        //Arrange
        char CHAR_VALUE = 'f';
        ...
        //Assert
        final char[] EXPECTED_BINARY_ARRAY = {'0','1','1','0','0','1','1','0'};
        assertArrayEquals(EXPECTED_BINARY_ARRAY, binaryArray);        
    }
    ...
    public void WHEN_charIs_C_THEN_convertCharToBinary_returnsBinaryRepresentationOfChar(){
        ...
        //Assert
        final char[] EXPECTED_BINARY_ARRAY = {'0','1','0','0','0','0','1','1'};
        assertArrayEquals(EXPECTED_BINARY_ARRAY, binaryArray);        
    }
    ...
    {
        //Arrange
        final char[] BINARY_ARRAY = {'0','1','0','0','0','0','1','1'};
    ...
    @Test
    public void WHEN_binaryNumberRepresentsChar_f_THEN_convertBinaryToChar_returnsChar()
    {
        //Arrange
        final char[] BINARY_ARRAY = {'0','1','1','0','0','1','1','0'};

        //Act
        char charValue = TP2PartieA.convertBinaryToChar(BINARY_ARRAY);

        //Assert
        final char EXPECTED_CHAR_VALUE = 'f';
        assertEquals(EXPECTED_CHAR_VALUE, charValue);
    }
